...
const ENABLED=path.join(STATE,'enabled'), ATTEMPTED=path.join(STATE,'attempted-ids-v4.txt'), DISCOVERED=path.join(STATE,'discovered-ids.txt'), CURSOR=path.join(STATE,'discovery-cursor-v4.txt'), BUFFER=path.join(STATE,'checkpoint-buffer.jsonl');
