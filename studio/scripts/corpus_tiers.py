...
ICONS_AND_INDIES: frozenset[str] = frozenset(
    {
        # Skate -- heritage
        "thrasher", "santa-cruz-au", "baker", "toy-machine", "zero",
        "deathwish", "chocolate", "volcom",
        # Skate -- modern independents
        "polar-skate", "quasi", "dime", "frog-skateboards", "limosine",
        "welcome-skateboards", "huf", "primitive", "last-resort-ab", "ripndip",
        # Streetwear -- heritage
        "stussy", "stussy-au", "bape", "obey", "the-hundreds", "undefeated",
        "neighborhood", "wtaps",
        # Streetwear -- modern independents
        "brain-dead", "born-x-raised", "noah-ny", "awake-ny", "cherry-la",
        "gallery-dept", "pleasures", "corteiz", "golf-wang", "kidsuper",
        "places-plus-faces", "market-studios", "aime-leon-dore",
        # Surf
        "katin", "captain-fin", "vissla", "misfit", "thrills", "rhythm",
        # Art and label independents
        "online-ceramics", "art-club-and-friends", "sub-pop", "matador-records",
        "stones-throw", "hello-merch",
        # Workwear and kustom heritage
        "filson", "carhartt", "dickies", "deus-au", "biltwell", "lowbrow-customs",
        # Counterculture
        "cookies", "sullen",
    }
)
