...
class SocialDerivative(Base):
    """Exact bytes generated by Social Studio for one output and its review decision."""
    ...
    __table_args__ = (
        ...
        Index("ix_social_derivatives_post_review_state", "social_post_id", "review_state"),
    )
