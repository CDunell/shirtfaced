...
def render_generation_prompt(direction: DesignDirection, phrase: str = "") -> str:
    ...
    return (
        ...
        "on every design, not a new invented one each time; render it as the wordmark or "
        "brand credit the concept calls for. Do not render this description's own wording as "
        "the printed text, and do not depict any real trademarked logo or brand name "
        "belonging to anyone else. If the concept calls for a character or mascot, "
