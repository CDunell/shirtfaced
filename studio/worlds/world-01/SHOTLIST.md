...
This is the production backlog for World 01.

It prevents repetition, balances hero products and camera positions, and
ensures the visual universe expands rather than circles back on itself.
...
------------------------------------------------------------------------
  ...
  W01-014   Kitchen kick-ons II       Hoodie waist   Facing from hallway ⬜
...
1.  Use the highest-priority Planned scene unless continuity requires
    otherwise.
