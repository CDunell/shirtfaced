...
const CATEGORIES = [
  { label: "Tees", href: "/products/tee", icon: IconShirt, tone: "#d8ef6d" },
  { label: "Hoodies", href: "/products/hoodie", icon: IconHoodie, tone: "#b9ddf3" },
  { label: "Crewnecks", href: "/products/crewneck", icon: IconShorts, tone: "#f8b3c6" },
  { label: "Bucket Hats", href: "/products/bucket-hat", icon: IconCap, tone: "#ffd45c" },
        ...
        <div className="grid grid-cols-[.9fr_1.1fr] items-center gap-4 sm:grid-cols-2 sm:gap-6">
          <div>
            ...
            <div className="mt-4 flex flex-col items-start gap-2 sm:flex-row">
              <Link href="/products/tee" className="press inline-flex min-h-11 items-center rounded-md bg-ink px-3 py-2.5 text-[11px] font-black uppercase text-paper sm:px-4 sm:py-3">Shop tees</Link>
              <Link href="/products/hoodie" className="press inline-flex min-h-11 items-center rounded-md bg-ink px-3 py-2.5 text-[11px] font-black uppercase text-paper sm:px-4 sm:py-3">Shop hoodies</Link>
            </div>
          </div>
          {photo ? (
