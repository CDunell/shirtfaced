...
import { CREATURES, UI_ACCENTS } from "@/lib/creatures";
        ...
        <div className="mx-auto max-w-5xl">
            ...
            {PLAY_CREATURES.map((creature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <img src={`/creatures/masters/${creature.slug}.svg`} alt="" className="h-11 w-16 object-contain brightness-0" />
          ...
          >
            ...
            {stamps.map((stamp) => (
              ...
              <img
                key={stamp.id}
                src={`/creatures/masters/${stamp.slug}.svg`}
                alt={stamp.name}
                draggable={false}
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
            {SOUND_CREATURES.map((sound, index) => {
              ...
              return (
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={`/creatures/masters/${creature.slug}.svg`} alt="" className="mx-auto h-16 w-full object-contain brightness-0" />
