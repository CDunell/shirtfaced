...
export function CurbStampsLogoTransparent({ className = "" }: Props) {
  return (
    <svg viewBox="0 0 240 130" role="img" aria-label="Curb Stamps" className={className}>
      <path d="M17 31C24 12 56 8 88 12c28 3 47-2 70 1 34 4 55 16 61 38 6 21 2 47-10 59-13 12-38 15-66 14-25-1-40 2-66 0-28-2-50-6-59-20C8 89 9 53 17 31Z" fill="#d7ff18"/>
